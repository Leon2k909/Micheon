...
const PARAGRAPH_TEST_ITEMS = [
  {
    id: "test-paragraph-extra-easy-shopping",
    de: "Am Samstag gehe ich immer einkaufen. Ich schreibe vorher eine Liste, weil ich sonst die Hälfte vergesse. Meistens brauche ich Brot, Milch und Obst.",
    en: "I always go shopping on Saturdays. I write a list beforehand, because otherwise I forget half of it. Usually I need bread, milk and fruit.",
    level: "A1-A2",
    topic: "Doing the shopping",
    hard: false,
  },
  {
    id: "test-paragraph-extra-easy-flat",
    de: "Wir wohnen im dritten Stock, leider ohne Aufzug. Die Wohnung hat zwei Zimmer und einen kleinen Balkon. Im Sommer sitzen wir dort fast jeden Abend.",
    en: "We live on the third floor, unfortunately without a lift. The flat has two rooms and a small balcony. In summer we sit out there almost every evening.",
    level: "A1-A2",
    topic: "Where I live",
    hard: false,
  },
  {
    id: "test-paragraph-extra-easy-pet",
    de: "Unser Hund heißt Rocky und ist schon zehn Jahre alt. Morgens gehe ich mit ihm Gassi, abends macht das mein Bruder. Er schläft am liebsten in der Küche.",
    en: "Our dog is called Rocky and is already ten years old. I take him out in the morning, my brother does it in the evening. He likes sleeping in the kitchen best.",
    level: "A1-A2",
    topic: "The dog",
    hard: false,
  },
  {
    id: "test-paragraph-extra-easy-weather",
    de: "Heute ist es ziemlich kalt und es regnet seit dem Morgen. Ich bleibe lieber drinnen und trinke einen Tee. Morgen soll es wieder besser werden.",
    en: "It's fairly cold today and it's been raining since this morning. I'd rather stay in and drink a tea. It's supposed to be better again tomorrow.",
    level: "A1-A2",
    topic: "The weather",
    hard: false,
  },
  {
    id: "test-paragraph-extra-easy-school",
    de: "Meine Tochter kommt um halb zwei nach Hause. Zuerst isst sie etwas, dann macht sie ihre Hausaufgaben. Danach darf sie eine Stunde spielen.",
    en: "My daughter gets home at half past one. First she eats something, then she does her homework. After that she's allowed to play for an hour.",
    level: "A1-A2",
    topic: "After school",
    hard: false,
  },
  {
    id: "test-paragraph-extra-mid-move",
    de: "Wir sind vor drei Wochen umgezogen und suchen immer noch die Hälfte unserer Sachen. Der Umzug selbst ging schnell, weil Freunde geholfen haben. Am schlimmsten war, dass der Aufzug an dem Tag ausgefallen ist.",
    en: "We moved three weeks ago and are still looking for half our things. The move itself went quickly because friends helped. The worst part was that the lift was out of order that day.",
    level: "B1",
    topic: "Moving flat",
    hard: false,
  },
  {
    id: "test-paragraph-extra-mid-doctor",
    de: "Ich hatte seit Tagen Halsschmerzen und bin schließlich zum Arzt gegangen. Er hat mich untersucht und gesagt, es sei nichts Ernstes. Trotzdem soll ich mich ein paar Tage schonen.",
    en: "I'd had a sore throat for days and finally went to the doctor. He examined me and said it was nothing serious. All the same, I'm supposed to take it easy for a few days.",
    level: "B1",
    topic: "At the doctor's",
    hard: false,
  },
  {
    id: "test-paragraph-extra-mid-neighbour",
    de: "Unsere neue Nachbarin hat sich gleich am ersten Tag vorgestellt und uns Kuchen gebracht. Das ist bei uns im Haus nicht selbstverständlich. Seitdem grüßen sich plötzlich alle im Treppenhaus.",
    en: "Our new neighbour introduced herself on the very first day and brought us cake. That isn't a given in our building. Since then everyone suddenly says hello in the stairwell.",
    level: "B1",
    topic: "Neighbours",
    hard: false,
  },
  {
    id: "test-paragraph-extra-mid-work",
    de: "Seit dem Frühjahr arbeite ich nur noch drei Tage im Büro und den Rest von zu Hause. Anfangs fiel es mir schwer, Arbeit und Alltag zu trennen. Inzwischen möchte ich es nicht mehr anders haben.",
    en: "Since the spring I've only been working three days in the office and the rest from home. At first I found it hard to separate work from everyday life. By now I wouldn't want it any other way.",
    level: "B1",
    topic: "A change at work",
    hard: false,
  },
  {
    id: "test-paragraph-extra-hard-language",
    de: "Am Anfang hatte ich das Gefühl, keinerlei Fortschritte zu machen, obwohl ich jeden Tag geübt habe. Erst nach Monaten merkte ich, dass ich Gespräche verstand, ohne bewusst zu übersetzen. Rückblickend war genau diese unauffällige Phase die wichtigste.",
    en: "At the beginning I had the feeling I was making no progress at all, even though I practised every day. Only after months did I notice that I was understanding conversations without consciously translating. Looking back, that unremarkable phase was precisely the most important one.",
    level: "B2",
    topic: "Learning a language",
    hard: true,
  },
  {
    id: "test-paragraph-extra-hard-city",
    de: "Das Viertel hat sich in den letzten zehn Jahren stark verändert, und nicht alle finden das gut. Wo früher kleine Werkstätten waren, stehen heute Cafés, in denen ein Kaffee so viel kostet wie früher ein Mittagessen. Wer schon lange hier wohnt, kann sich die Miete kaum noch leisten.",
    en: "The district has changed a great deal in the last ten years, and not everyone thinks that's a good thing. Where there used to be small workshops there are now cafés in which a coffee costs as much as a lunch once did. Anyone who has lived here a long time can barely afford the rent any more.",
    level: "B2",
    topic: "How a city changes",
    hard: true,
  },
  {
    id: "test-paragraph-extra-hard-volunteer",
    de: "Sie engagiert sich seit Jahren ehrenamtlich, ohne je darüber zu sprechen. Erst als der Verein einen Preis bekam, erfuhren die meisten, wie viel Arbeit tatsächlich an ihr hing. Gefragt, warum sie das mache, zuckte sie nur mit den Schultern.",
    en: "She has been volunteering for years without ever talking about it. Only when the club received an award did most people find out how much of the work actually rested on her. Asked why she did it, she just shrugged.",
    level: "B2",
    topic: "Volunteering",
    hard: true,
  },
  {
    id: "test-paragraph-extra-hard-argument",
    de: "Es fällt mir leichter, einer sachlichen Kritik zuzustimmen, als einem übertriebenen Lob. Bei dem einen weiß ich, woran ich bin; bei dem anderen frage ich mich unwillkürlich, was dahintersteckt. Vermutlich sagt das mehr über mich aus als über meine Gesprächspartner.",
    en: "I find it easier to agree with measured criticism than with excessive praise. With the one I know where I stand; with the other I can't help wondering what lies behind it. That probably says more about me than about the people I'm talking to.",
    level: "C1",
    topic: "Disagreeing well",
    hard: true,
  },
  {
    id: "test-paragraph-extra-hard-memory",
    de: "Erinnerungen sind weniger zuverlässig, als man gemeinhin annimmt: Jedes Mal, wenn wir sie hervorholen, schreiben wir sie ein wenig um. Was uns besonders lebendig erscheint, ist deshalb nicht selten gerade das, was am häufigsten erzählt wurde. Insofern erinnern wir uns eher an unsere Erzählungen als an die Ereignisse selbst.",
    en: "Memories are less reliable than is commonly assumed: every time we retrieve them, we rewrite them a little. What seems especially vivid to us is therefore not infrequently precisely what has been recounted most often. In that sense we remember our accounts rather than the events themselves.",
    level: "C1",
    topic: "Remembering",
    hard: true,
  },
  {
    id: "test-paragraph-extra-hard-work-culture",
    de: "Was in dem einen Unternehmen als angenehm direkt gilt, wird im nächsten bereits als schroff empfunden. Wer die Stelle wechselt, unterschätzt regelmäßig, wie viel Einarbeitung nicht die Aufgabe selbst betrifft, sondern den Ton. Die fachliche Seite hat man meist nach Wochen begriffen, die ungeschriebenen Regeln erst nach Monaten.",
    en: "What counts as pleasantly direct in one company is already felt to be brusque in the next. People changing jobs regularly underestimate how much of the settling in concerns not the work itself but the tone. The technical side is usually grasped within weeks, the unwritten rules only after months.",
    level: "C1",
  ...
  },
  {
    ...
    de: "Eine Sprache lernt man nicht dadurch, dass man Vokabeln auswendig lernt, sondern dadurch, dass man sie benutzt, auch wenn man dabei ständig Fehler macht. Wer darauf wartet, bis er alles richtig sagen kann, fängt nie an zu sprechen.",
    en: "You don't learn a language by memorising vocabulary, but by using it, even if you're constantly making mistakes while you do. Anyone waiting until they can say everything correctly never starts speaking at all.",
    level: "B2",
    topic: "Learning",
    hard: true,
  },
  ...
  },
  {
    ...
    de: "Wir hatten eigentlich vor, im Herbst umzuziehen, aber inzwischen spricht einiges dafür, noch ein Jahr zu warten und in Ruhe zu suchen. Die Mieten sind gerade absurd, und unser Vertrag läuft ohnehin erst nächsten Sommer aus.",
    en: "We were actually planning to move in the autumn, but by now there's quite a lot to be said for waiting another year and looking without rushing. Rents are absurd at the moment, and our contract doesn't run out until next summer anyway.",
    level: "B2",
    topic: "Plans",
    hard: true,
  },
            ...
            <label className="mt-6 block">
              ...
              {isParagraph ? (
                <textarea
                  ...
                  className={cn(
                    "min-h-40 w-full resize-y rounded-[18px] border-2 bg-[var(--surface)] px-5 py-4 text-base font-bold leading-7 text-[var(--text-1)] outline-none transition-colors placeholder:text-[var(--text-3)] test-answer-field",
                    feedback
                      ? feedback.correct
                        ? "border-emerald-500"
                        : "border-rose-500"
                ...
                <input
                  ...
                  ref={(element) => { answerInputRef.current = element; }}
                  className={cn(
                    "h-16 w-full rounded-[18px] border-2 bg-[var(--surface)] px-5 text-lg font-bold text-[var(--text-1)] outline-none transition-colors placeholder:text-[var(--text-3)] test-answer-field",
                    feedback
                      ? feedback.correct
                        ? "border-emerald-500"
                        : "border-rose-500"
