 ...
 * translations.ts.
 */
const COURSE_BY_PACK: Record<string, string> = { fr: "french", pl: "polish", es: "spanish", pt: "portuguese", el: "greek", sq: "albanian" };
...
const COURSE_SEARCH_ALIASES: Record<string, string> = {
  ...
  albanian: "sq shqip shqipe shqiperi shqipëri albania kosovo albanisch albanien albanais albanese albanés albanês albański албанский",
