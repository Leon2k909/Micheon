...
export function MuteButton({
  ...
  const greekMuted = isTtsLanguageMuted("greek");
  const albanianMuted = isTtsLanguageMuted("albanian");
  /**
  ...
  const mixer = open && typeof document !== "undefined" ? createPortal(
    ...
    >
      ...
      {inPlay.includes("spanish") && (
        <VolumeRow
          label={ui("Spanish voice")}
          muteLabel={ui("Mute Spanish voice")}
          muted={spanishMuted}
          onChange={(value) => setLanguageVolume("spanish", value)}
          onToggleMuted={() => toggleTtsLanguageMuted("spanish")}
          testId="spanish"
      ...
      {inPlay.includes("greek") && (
        <VolumeRow
          label={ui("Greek voice")}
          muteLabel={ui("Mute Greek voice")}
          muted={greekMuted}
          onChange={(value) => setLanguageVolume("greek", value)}
          onToggleMuted={() => toggleTtsLanguageMuted("greek")}
          testId="greek"
          unmuteLabel={ui("Unmute Greek voice")}
          value={settings.greekVolume}
        />
      )}
      {inPlay.includes("albanian") && (
        <VolumeRow
          label={ui("Albanian voice")}
          muteLabel={ui("Mute Albanian voice")}
          muted={albanianMuted}
          onChange={(value) => setLanguageVolume("albanian", value)}
          onToggleMuted={() => toggleTtsLanguageMuted("albanian")}
          testId="albanian"
          unmuteLabel={ui("Unmute Albanian voice")}
          value={settings.albanianVolume}
        />
      )}
      <div className="audio-mixer-divider" />
