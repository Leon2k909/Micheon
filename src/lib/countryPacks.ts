 ...
 * loses the progress they have. Germany is the same shape filled with German
 * material, which is the whole point: same structure, same flow, different
 * content.
 *
 * Adding a third country means adding a bundle here and nothing else.
 */
...
export const COUNTRY_PACKS: CountryPack[] = [UK_PACK, DE_PACK];
