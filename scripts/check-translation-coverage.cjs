...
const FLOORS = {
  ...
  it: 22000,
  // Portuguese is finished too, and further along than any of them: all 9,000
  // word cards, all 3,500 spoken lines, all 12,041 sentences, and every one of
  // the 780 conversations reaches the learner. It leaves nothing out — the
  // packs about how German is written and the traps that only catch an English
  // speaker were refused for a while and are now carried, with the German
  // letter or word in guillemets as the thing the card is about. Floored close
  // to what it reached, for the reason Italian is.
  pt: 25200,
