...
for (const direction of ["learn-de", "learn-en", "learn-fr", "learn-pl", "learn-es", "learn-it", "learn-pt", "learn-ru", "learn-el", "learn-sq"]) {
...
console.log(
  ...
  + `${M.placementQuestions("learn-es").length} Spanish, ${M.placementQuestions("learn-it").length} Italian, `
  + `${M.placementQuestions("learn-pt").length} Portuguese, ${M.placementQuestions("learn-ru").length} Russian, `
  + `${M.placementQuestions("learn-el").length} Greek and ${M.placementQuestions("learn-sq").length} Albanian `
