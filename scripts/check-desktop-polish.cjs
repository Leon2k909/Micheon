...
check("the prototype guided lesson uses a calm floral frame without a green wash", guidedCanvas.includes("--fs-bg: #fffaf1;") && guidedCanvas.includes('url("./prototype/assets/guided-garden-frame-v1.png")') && guidedCanvas.includes("rgba(255, 252, 245, 0.12)") && !guidedCanvas.includes("radial-gradient") && !appStyles.includes(".prototype-guided-session::before"));
