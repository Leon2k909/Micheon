...
check("the prototype guided lesson lets learners choose a calm background without a green wash", guidedCanvas.includes("--fs-bg: #fffaf1;") && appStyles.includes("guided-background-garden") && appStyles.includes('url("./prototype/assets/guided-garden-frame-v1.png")') && appStyles.includes("guided-background-dawn") && appStyles.includes("guided-background-plain") && !appStyles.includes(".prototype-guided-session::before"));
